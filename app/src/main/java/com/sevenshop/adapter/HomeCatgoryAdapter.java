...
import com.sevenshop.bean.HomeCampaignBean;
    ...
    protected void convert(BaseViewHolder holder, HomeCampaignBean bean) {
        switch (bean.getItemType()) {
            ...
            case HomeCampaignBean.ITEM_TYPE_LEFT:
                ...
                GlideUtils.load(SevenShopApplication.sContext, bean.getCpOne().getImgUrl(),
                        (ImageView) holder.getView(R.id.imgview_big));
                GlideUtils.load(SevenShopApplication.sContext, bean.getCpTwo().getImgUrl(),
                        (ImageView) holder.getView(R.id.imgview_small_top));
                GlideUtils.load(SevenShopApplication.sContext, bean.getCpThree().getImgUrl(),
