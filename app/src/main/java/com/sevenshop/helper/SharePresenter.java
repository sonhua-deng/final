...
import com.sevenshop.utils.AppExistUtils;
        ...
        switch (view.getId()) {
            case R.id.weixin:
                ...
                if (wx) {
                    ...
                    ToastUtils.showSafeToast(SevenShopApplication.sContext,"未安装微信,无法分享");
                    dialog.dismiss();
                }
                break;
            case R.id.wxcircle:
            ...
            case R.id.sina:
                ...
                if (wb) {
                    ...
                    ToastUtils.showSafeToast(SevenShopApplication.sContext,"未安装微博,无法分享");
                    dialog.dismiss();
                }
                break;
            case R.id.qq:
                ...
                if (qq) {
                    ...
                    ToastUtils.showSafeToast(SevenShopApplication.sContext,"未安装QQ,无法分享");
                    dialog.dismiss();
                }
                break;
            case R.id.qzone:
